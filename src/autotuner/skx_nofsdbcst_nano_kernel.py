...
class SkxNofsdbcstNanoKernel(NanoKernel):
    ...
    def rewrite(
        ...
        *,
        ...
        vector_length = isa_info.vector_type.bitwidth() // op.datatype.bitwidth
        ...
        for _ in range(tile.k):
            a_vectors = tuple(
                load_vector(
                    ...
                    vector_register(
                        1 + m, vector_type, disable_regalloc=disable_regalloc
                    ),
            ...
            for n in range(tile.n):
                b_vector = broadcast_scalar(
                    ...
                    vector_register(0, vector_type, disable_regalloc=disable_regalloc),
                )
