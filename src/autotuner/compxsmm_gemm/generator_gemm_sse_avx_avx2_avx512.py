...
from autotuner.compxsmm_gemm.tiling import (
    KPhaseKind,
    compxsmm_generator_gemm_sse_avx_avx2_avx512_compute_k_plan,
    compxsmm_generator_gemm_sse_avx_avx2_avx512_compute_max_n_blocking,
    compxsmm_generator_gemm_sse_avx_avx2_avx512_iter_m_loops,
    compxsmm_generator_gemm_sse_avx_avx2_avx512_iter_n_loops,
)
...
def compxsmm_generator_gemm_sse_avx_avx2_avx512_kernel(
    ...
    max_n_blocking = compxsmm_generator_gemm_sse_avx_avx2_avx512_compute_max_n_blocking(
        micro_kernel_config, desc, generated_code.arch
    )
    n_loops = compxsmm_generator_gemm_sse_avx_avx2_avx512_iter_n_loops(
    ...
    for n_loop in n_loops:
        ...
        for m_loop in compxsmm_generator_gemm_sse_avx_avx2_avx512_iter_m_loops(
            micro_kernel_config, desc, generated_code.arch
        ):
...
def compxsmm_generator_gemm_sse_avx_avx2_avx512_kloop(
    ...
    k_plan = compxsmm_generator_gemm_sse_avx_avx2_avx512_compute_k_plan(
