module {
  ...
  transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
    %0 = transform.structured.match attributes {__node0__} in %arg0 : (!transform.any_op) -> !transform.any_op
    ...
    transform.annotate %loops "__node0__/I" : !transform.any_op
    ...
    transform.annotate %loops_1 "__node0__/K" : !transform.any_op
