...
// RUN: compxsmm-gemm dense %t matmul_bac 8 1 1 8 1 8 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,convert-x86-scf-to-x86,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// CHECK-IR-LIBXSMM-NEXT:      %32 = x86.ri.sub %31, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%21], %30 : (!x86.reg64<rdx>, !x86.avx512reg<zmm31>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      %33 = x86.ri.add %21, 64 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %34 = x86.ri.sub %29, 0 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %35 = x86.si.cmp %26, 8 : (!x86.reg64<r10>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %35 : !x86.rflags<rflags>, ^bb2(%34 : !x86.reg64<rdi>, %32 : !x86.reg64<rsi>, %33 : !x86.reg64<rdx>, %22 : !x86.reg64<rbp>, %23 : !x86.reg64<rsp>, %24 : !x86.reg64<r11>, %26 : !x86.reg64<r10>), ^bb3(%34 : !x86.reg64<rdi>, %32 : !x86.reg64<rsi>, %33 : !x86.reg64<rdx>, %22 : !x86.reg64<rbp>, %23 : !x86.reg64<rsp>, %24 : !x86.reg64<r11>, %26 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb3(%36: !x86.reg64<rdi>, %37: !x86.reg64<rsi>, %38: !x86.reg64<rdx>, %39: !x86.reg64<rbp>, %40: !x86.reg64<rsp>, %41: !x86.reg64<r11>, %42: !x86.reg64<r10>):
// CHECK-IR-LIBXSMM-NEXT:      %43 = x86.ri.add %38, 0 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %44 = x86.ri.add %37, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      %45 = x86.ri.sub %36, 64 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %46 = x86.si.cmp %41, 1 : (!x86.reg64<r11>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %46 : !x86.rflags<rflags>, ^bb1(%45 : !x86.reg64<rdi>, %44 : !x86.reg64<rsi>, %43 : !x86.reg64<rdx>, %39 : !x86.reg64<rbp>, %40 : !x86.reg64<rsp>, %41 : !x86.reg64<r11>), ^bb4(%45 : !x86.reg64<rdi>, %44 : !x86.reg64<rsi>, %43 : !x86.reg64<rdx>, %39 : !x86.reg64<rbp>, %40 : !x86.reg64<rsp>, %41 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb4(%47: !x86.reg64<rdi>, %48: !x86.reg64<rsi>, %49: !x86.reg64<rdx>, %50: !x86.reg64<rbp>, %51: !x86.reg64<rsp>, %52: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %53 = x86.ds.mov %50 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-IR-LIBXSMM-NEXT:      %54, %55 = x86.d.pop %53 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
