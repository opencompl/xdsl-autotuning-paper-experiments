...
// RUN: compxsmm-gemm dense %t matmul_bac 50 38 128 50 128 50 1 1 1 1 skx nopf SP && xdsl-opt %t -f mlir -p convert-x86-scf-to-x86,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
