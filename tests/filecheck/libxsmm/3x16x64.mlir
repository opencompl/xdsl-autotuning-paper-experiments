...
// CHECK-NEXT:    x86.fallthrough ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>)
// CHECK-NEXT:  ^{{.*}}(%{{.*}}: !x86.reg64<rdi>, %{{.*}}: !x86.reg64<rsi>, %{{.*}}: !x86.reg64<rdx>, %{{.*}}: !x86.reg64<rbp>, %{{.*}}: !x86.reg64<rsp>, %{{.*}}: !x86.reg64<r11>):
// CHECK-NEXT:    x86.label "l33"
// CHECK-NEXT:    %{{.*}} = x86.ri.add %{{.*}}, 3 : (!x86.reg64<r11>) -> !x86.reg64<r11>
// CHECK-NEXT:    %{{.*}} = x86.di.mov 0 : () -> !x86.reg64<r10>
// CHECK-NEXT:    x86.fallthrough ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>)
// CHECK-NEXT:  ^{{.*}}(%{{.*}}: !x86.reg64<rdi>, %{{.*}}: !x86.reg64<rsi>, %{{.*}}: !x86.reg64<rdx>, %{{.*}}: !x86.reg64<rbp>, %{{.*}}: !x86.reg64<rsp>, %{{.*}}: !x86.reg64<r11>, %{{.*}}: !x86.reg64<r10>):
...
// CHECK-NEXT:    x86.fallthrough ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>, %{{.*}} : !x86.avx512reg<zmm26>, %{{.*}} : !x86.avx512reg<zmm27>, %{{.*}} : !x86.avx512reg<zmm28>, %{{.*}} : !x86.avx512reg<zmm29>, %{{.*}} : !x86.avx512reg<zmm30>, %{{.*}} : !x86.avx512reg<zmm31>, %{{.*}} : !x86.reg64<r12>)
// CHECK-NEXT:  ^{{.*}}(%{{.*}}: !x86.reg64<rdi>, %{{.*}}: !x86.reg64<rsi>, %{{.*}}: !x86.reg64<rdx>, %{{.*}}: !x86.reg64<rbp>, %{{.*}}: !x86.reg64<rsp>, %{{.*}}: !x86.reg64<r11>, %{{.*}}: !x86.reg64<r10>, %{{.*}}: !x86.avx512reg<zmm26>, %{{.*}}: !x86.avx512reg<zmm27>, %{{.*}}: !x86.avx512reg<zmm28>, %{{.*}}: !x86.avx512reg<zmm29>, %{{.*}}: !x86.avx512reg<zmm30>, %{{.*}}: !x86.avx512reg<zmm31>, %{{.*}}: !x86.reg64<r12>):
...
// CHECK-NEXT:    x86.c.jl %{{.*}} : !x86.rflags<rflags>, ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>, %{{.*}} : !x86.avx512reg<zmm26>, %{{.*}} : !x86.avx512reg<zmm27>, %{{.*}} : !x86.avx512reg<zmm28>, %{{.*}} : !x86.avx512reg<zmm29>, %{{.*}} : !x86.avx512reg<zmm30>, %{{.*}} : !x86.avx512reg<zmm31>, %{{.*}} : !x86.reg64<r12>), ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>, %{{.*}} : !x86.avx512reg<zmm26>, %{{.*}} : !x86.avx512reg<zmm27>, %{{.*}} : !x86.avx512reg<zmm28>, %{{.*}} : !x86.avx512reg<zmm29>, %{{.*}} : !x86.avx512reg<zmm30>, %{{.*}} : !x86.avx512reg<zmm31>, %{{.*}} : !x86.reg64<r12>)
// CHECK-NEXT:    ^{{.*}}(%{{.*}} !x86.reg64<rdi>, %{{.*}} !x86.reg64<rsi>, %{{.*}} !x86.reg64<rdx>, %{{.*}} !x86.reg64<rbp>, %{{.*}} !x86.reg64<rsp>, %{{.*}} !x86.reg64<r11>, %{{.*}} !x86.reg64<r10>, %{{.*}} !x86.avx512reg<zmm26>, %{{.*}} !x86.avx512reg<zmm27>, %{{.*}} !x86.avx512reg<zmm28>, %{{.*}} !x86.avx512reg<zmm29>, %{{.*}} !x86.avx512reg<zmm30>, %{{.*}} !x86.avx512reg<zmm31>, %{{.*}} !x86.reg64<r12>):
...
// CHECK-NEXT:    x86.c.jl %{{.*}} : !x86.rflags<rflags>, ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>), ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>, %{{.*}} : !x86.reg64<r10>)
// CHECK-NEXT:  ^{{.*}}(%{{.*}}: !x86.reg64<rdi>, %{{.*}}: !x86.reg64<rsi>, %{{.*}}: !x86.reg64<rdx>, %{{.*}}: !x86.reg64<rbp>, %{{.*}}: !x86.reg64<rsp>, %{{.*}}: !x86.reg64<r11>, %{{.*}}: !x86.reg64<r10>):
...
// CHECK-NEXT:    x86.c.jl %{{.*}} : !x86.rflags<rflags>, ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>), ^{{.*}}(%{{.*}} : !x86.reg64<rdi>, %{{.*}} : !x86.reg64<rsi>, %{{.*}} : !x86.reg64<rdx>, %{{.*}} : !x86.reg64<rbp>, %{{.*}} : !x86.reg64<rsp>, %{{.*}} : !x86.reg64<r11>)
// CHECK-NEXT:  ^{{.*}}(%{{.*}}: !x86.reg64<rdi>, %{{.*}}: !x86.reg64<rsi>, %{{.*}}: !x86.reg64<rdx>, %{{.*}}: !x86.reg64<rbp>, %{{.*}}: !x86.reg64<rsp>, %{{.*}}: !x86.reg64<r11>):
