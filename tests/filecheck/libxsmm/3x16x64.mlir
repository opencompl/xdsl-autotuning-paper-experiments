...
// CHECK-NEXT:    x86.fallthrough ^{{.*}}(%{{.*}} : !x86.reg<rdi>, %{{.*}} : !x86.reg<rsi>, %{{.*}} : !x86.reg<rdx>, %{{.*}} : !x86.reg<rbp>, %{{.*}} : !x86.reg<rsp>, %{{.*}} : !x86.reg<r10>, %{{.*}} : !x86.reg<r11>)
...
// CHECK-NEXT:    %{{.*}} = x86.dm.vmovapd %{{.*}} : (!x86.reg<rdx>) -> !x86.avx512reg<zmm26>
...
// CHECK-NEXT:    x86.fallthrough ^{{.*}}(%{{.*}} : !x86.reg<rdi>, %{{.*}} : !x86.reg<rsi>, %{{.*}} : !x86.reg<rdx>, %{{.*}} : !x86.reg<rbp>, %{{.*}} : !x86.reg<rsp>, %{{.*}} : !x86.reg<r10>, %{{.*}} : !x86.reg<r11>, %{{.*}} : !x86.avx512reg<zmm26>, %{{.*}} : !x86.avx512reg<zmm27>, %{{.*}} : !x86.avx512reg<zmm28>, %{{.*}} : !x86.avx512reg<zmm29>, %{{.*}} : !x86.avx512reg<zmm30>, %{{.*}} : !x86.avx512reg<zmm31>, %{{.*}} : !x86.reg<r12>)
...
// CHECK-NEXT:    %{{.*}} = x86.dm.vmovapd %{{.*}} : (!x86.reg<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-NEXT:    %{{.*}} = x86.dm.vmovapd %{{.*}}, 64 : (!x86.reg<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-NEXT:    %{{.*}} = x86.dm.vbroadcastsd %{{.*}} : (!x86.reg<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:    x86.ms.vmovapd %{{.*}}, %{{.*}} : (!x86.reg<rdx>, !x86.avx512reg<zmm26>) -> ()
...
// CHECK-NEXT:    %{{.*}}, %{{.*}} = x86.d.pop %{{.*}} : (!x86.reg<rsp>) -> (!x86.reg<rsp>, !x86.reg<rbp>)
