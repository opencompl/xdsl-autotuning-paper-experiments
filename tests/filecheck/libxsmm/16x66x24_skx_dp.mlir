...
// RUN: compxsmm-gemm dense %t matmul_bac 16 66 24 16 24 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,convert-x86-scf-to-x86,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %317 : !x86.rflags<rflags>, ^bb2(%316 : !x86.reg64<rdi>, %314 : !x86.reg64<rsi>, %315 : !x86.reg64<rdx>, %281 : !x86.reg64<rbp>, %282 : !x86.reg64<rsp>, %283 : !x86.reg64<r11>, %284 : !x86.reg64<r10>), ^bb5(%316 : !x86.reg64<rdi>, %314 : !x86.reg64<rsi>, %315 : !x86.reg64<rdx>, %281 : !x86.reg64<rbp>, %282 : !x86.reg64<rsp>, %283 : !x86.reg64<r11>, %284 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb5(%318: !x86.reg64<rdi>, %319: !x86.reg64<rsi>, %320: !x86.reg64<rdx>, %321: !x86.reg64<rbp>, %322: !x86.reg64<rsp>, %323: !x86.reg64<r11>, %324: !x86.reg64<r10>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %328 : !x86.rflags<rflags>, ^bb1(%327 : !x86.reg64<rdi>, %326 : !x86.reg64<rsi>, %325 : !x86.reg64<rdx>, %321 : !x86.reg64<rbp>, %322 : !x86.reg64<rsp>, %323 : !x86.reg64<r11>), ^bb6(%327 : !x86.reg64<rdi>, %326 : !x86.reg64<rsi>, %325 : !x86.reg64<rdx>, %321 : !x86.reg64<rbp>, %322 : !x86.reg64<rsp>, %323 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb6(%329: !x86.reg64<rdi>, %330: !x86.reg64<rsi>, %331: !x86.reg64<rdx>, %332: !x86.reg64<rbp>, %333: !x86.reg64<rsp>, %334: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %335 = x86.di.mov 14 : () -> !x86.reg64<r11>
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb7(%329 : !x86.reg64<rdi>, %330 : !x86.reg64<rsi>, %331 : !x86.reg64<rdx>, %332 : !x86.reg64<rbp>, %333 : !x86.reg64<rsp>, %335 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb7(%336: !x86.reg64<rdi>, %337: !x86.reg64<rsi>, %338: !x86.reg64<rdx>, %339: !x86.reg64<rbp>, %340: !x86.reg64<rsp>, %341: !x86.reg64<r11>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb8(%336 : !x86.reg64<rdi>, %337 : !x86.reg64<rsi>, %338 : !x86.reg64<rdx>, %339 : !x86.reg64<rbp>, %340 : !x86.reg64<rsp>, %342 : !x86.reg64<r11>, %343 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb8(%344: !x86.reg64<rdi>, %345: !x86.reg64<rsi>, %346: !x86.reg64<rdx>, %347: !x86.reg64<rbp>, %348: !x86.reg64<rsp>, %349: !x86.reg64<r11>, %350: !x86.reg64<r10>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %586 : !x86.rflags<rflags>, ^bb9(%583 : !x86.reg64<rdi>, %582 : !x86.reg64<rsi>, %381 : !x86.reg64<rdx>, %382 : !x86.reg64<rbp>, %383 : !x86.reg64<rsp>, %384 : !x86.reg64<r11>, %385 : !x86.reg64<r10>, %546 : !x86.avx512reg<zmm6>, %547 : !x86.avx512reg<zmm7>, %549 : !x86.avx512reg<zmm8>, %550 : !x86.avx512reg<zmm9>, %552 : !x86.avx512reg<zmm10>, %553 : !x86.avx512reg<zmm11>, %555 : !x86.avx512reg<zmm12>, %556 : !x86.avx512reg<zmm13>, %558 : !x86.avx512reg<zmm14>, %559 : !x86.avx512reg<zmm15>, %561 : !x86.avx512reg<zmm16>, %562 : !x86.avx512reg<zmm17>, %564 : !x86.avx512reg<zmm18>, %565 : !x86.avx512reg<zmm19>, %567 : !x86.avx512reg<zmm20>, %568 : !x86.avx512reg<zmm21>, %570 : !x86.avx512reg<zmm22>, %571 : !x86.avx512reg<zmm23>, %573 : !x86.avx512reg<zmm24>, %574 : !x86.avx512reg<zmm25>, %576 : !x86.avx512reg<zmm26>, %577 : !x86.avx512reg<zmm27>, %579 : !x86.avx512reg<zmm28>, %580 : !x86.avx512reg<zmm29>, %584 : !x86.avx512reg<zmm30>, %585 : !x86.avx512reg<zmm31>, %413 : !x86.reg64<r12>), ^bb10(%583 : !x86.reg64<rdi>, %582 : !x86.reg64<rsi>, %381 : !x86.reg64<rdx>, %382 : !x86.reg64<rbp>, %383 : !x86.reg64<rsp>, %384 : !x86.reg64<r11>, %385 : !x86.reg64<r10>, %546 : !x86.avx512reg<zmm6>, %547 : !x86.avx512reg<zmm7>, %549 : !x86.avx512reg<zmm8>, %550 : !x86.avx512reg<zmm9>, %552 : !x86.avx512reg<zmm10>, %553 : !x86.avx512reg<zmm11>, %555 : !x86.avx512reg<zmm12>, %556 : !x86.avx512reg<zmm13>, %558 : !x86.avx512reg<zmm14>, %559 : !x86.avx512reg<zmm15>, %561 : !x86.avx512reg<zmm16>, %562 : !x86.avx512reg<zmm17>, %564 : !x86.avx512reg<zmm18>, %565 : !x86.avx512reg<zmm19>, %567 : !x86.avx512reg<zmm20>, %568 : !x86.avx512reg<zmm21>, %570 : !x86.avx512reg<zmm22>, %571 : !x86.avx512reg<zmm23>, %573 : !x86.avx512reg<zmm24>, %574 : !x86.avx512reg<zmm25>, %576 : !x86.avx512reg<zmm26>, %577 : !x86.avx512reg<zmm27>, %579 : !x86.avx512reg<zmm28>, %580 : !x86.avx512reg<zmm29>, %584 : !x86.avx512reg<zmm30>, %585 : !x86.avx512reg<zmm31>, %413 : !x86.reg64<r12>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb10(%587: !x86.reg64<rdi>, %588: !x86.reg64<rsi>, %589: !x86.reg64<rdx>, %590: !x86.reg64<rbp>, %591: !x86.reg64<rsp>, %592: !x86.reg64<r11>, %593: !x86.reg64<r10>, %594: !x86.avx512reg<zmm6>, %595: !x86.avx512reg<zmm7>, %596: !x86.avx512reg<zmm8>, %597: !x86.avx512reg<zmm9>, %598: !x86.avx512reg<zmm10>, %599: !x86.avx512reg<zmm11>, %600: !x86.avx512reg<zmm12>, %601: !x86.avx512reg<zmm13>, %602: !x86.avx512reg<zmm14>, %603: !x86.avx512reg<zmm15>, %604: !x86.avx512reg<zmm16>, %605: !x86.avx512reg<zmm17>, %606: !x86.avx512reg<zmm18>, %607: !x86.avx512reg<zmm19>, %608: !x86.avx512reg<zmm20>, %609: !x86.avx512reg<zmm21>, %610: !x86.avx512reg<zmm22>, %611: !x86.avx512reg<zmm23>, %612: !x86.avx512reg<zmm24>, %613: !x86.avx512reg<zmm25>, %614: !x86.avx512reg<zmm26>, %615: !x86.avx512reg<zmm27>, %616: !x86.avx512reg<zmm28>, %617: !x86.avx512reg<zmm29>, %618: !x86.avx512reg<zmm30>, %619: !x86.avx512reg<zmm31>, %620: !x86.reg64<r12>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %624 : !x86.rflags<rflags>, ^bb8(%623 : !x86.reg64<rdi>, %621 : !x86.reg64<rsi>, %622 : !x86.reg64<rdx>, %590 : !x86.reg64<rbp>, %591 : !x86.reg64<rsp>, %592 : !x86.reg64<r11>, %593 : !x86.reg64<r10>), ^bb11(%623 : !x86.reg64<rdi>, %621 : !x86.reg64<rsi>, %622 : !x86.reg64<rdx>, %590 : !x86.reg64<rbp>, %591 : !x86.reg64<rsp>, %592 : !x86.reg64<r11>, %593 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb11(%625: !x86.reg64<rdi>, %626: !x86.reg64<rsi>, %627: !x86.reg64<rdx>, %628: !x86.reg64<rbp>, %629: !x86.reg64<rsp>, %630: !x86.reg64<r11>, %631: !x86.reg64<r10>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %635 : !x86.rflags<rflags>, ^bb7(%634 : !x86.reg64<rdi>, %633 : !x86.reg64<rsi>, %632 : !x86.reg64<rdx>, %628 : !x86.reg64<rbp>, %629 : !x86.reg64<rsp>, %630 : !x86.reg64<r11>), ^bb12(%634 : !x86.reg64<rdi>, %633 : !x86.reg64<rsi>, %632 : !x86.reg64<rdx>, %628 : !x86.reg64<rbp>, %629 : !x86.reg64<rsp>, %630 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb12(%636: !x86.reg64<rdi>, %637: !x86.reg64<rsi>, %638: !x86.reg64<rdx>, %639: !x86.reg64<rbp>, %640: !x86.reg64<rsp>, %641: !x86.reg64<r11>):
