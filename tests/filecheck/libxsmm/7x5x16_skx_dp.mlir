...
// CHECK-IR-LIBXSMM-NEXT:      %65 = x86.dmk.vmovupd[%21], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
// CHECK-IR-LIBXSMM-NEXT:      %66 = x86.dmk.vmovupd[%21 + 56], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %72 = x86.dmk.vmovupd[%21 + 112], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %78 = x86.dmk.vmovupd[%21 + 168], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %84 = x86.dmk.vmovupd[%21 + 224], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %90 = x86.dmk.vmovupd[%21 + 280], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %96 = x86.dmk.vmovupd[%21 + 336], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %102 = x86.dmk.vmovupd[%21 + 392], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %108 = x86.dmk.vmovupd[%21 + 448], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %114 = x86.dmk.vmovupd[%21 + 504], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %120 = x86.dmk.vmovupd[%21 + 560], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %126 = x86.dmk.vmovupd[%21 + 616], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %132 = x86.dmk.vmovupd[%21 + 672], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %138 = x86.dmk.vmovupd[%21 + 728], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %144 = x86.dmk.vmovupd[%21 + 784], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %150 = x86.dmk.vmovupd[%21 + 840], %27 {z} : (!x86.reg64<rdi>, !x86.avx512maskreg<k1>) -> !x86.avx512reg<zmm1>
...
// CHECK-IR-LIBXSMM-NEXT:      %163 = x86.dss.addpd %145, %139 : (!x86.avx512reg<zmm22>, !x86.avx512reg<zmm27>) -> !x86.avx512reg<zmm27>
// CHECK-IR-LIBXSMM-NEXT:      %164 = x86.dss.addpd %146, %140 : (!x86.avx512reg<zmm23>, !x86.avx512reg<zmm28>) -> !x86.avx512reg<zmm28>
// CHECK-IR-LIBXSMM-NEXT:      %165 = x86.dss.addpd %147, %141 : (!x86.avx512reg<zmm24>, !x86.avx512reg<zmm29>) -> !x86.avx512reg<zmm29>
// CHECK-IR-LIBXSMM-NEXT:      %166 = x86.dss.addpd %148, %142 : (!x86.avx512reg<zmm25>, !x86.avx512reg<zmm30>) -> !x86.avx512reg<zmm30>
// CHECK-IR-LIBXSMM-NEXT:      %167 = x86.dss.addpd %149, %143 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm31>) -> !x86.avx512reg<zmm31>
// CHECK-IR-LIBXSMM-NEXT:      %168 = x86.dss.addpd %151, %163 : (!x86.avx512reg<zmm17>, !x86.avx512reg<zmm27>) -> !x86.avx512reg<zmm27>
// CHECK-IR-LIBXSMM-NEXT:      %169 = x86.dss.addpd %152, %164 : (!x86.avx512reg<zmm18>, !x86.avx512reg<zmm28>) -> !x86.avx512reg<zmm28>
// CHECK-IR-LIBXSMM-NEXT:      %170 = x86.dss.addpd %153, %165 : (!x86.avx512reg<zmm19>, !x86.avx512reg<zmm29>) -> !x86.avx512reg<zmm29>
// CHECK-IR-LIBXSMM-NEXT:      %171 = x86.dss.addpd %154, %166 : (!x86.avx512reg<zmm20>, !x86.avx512reg<zmm30>) -> !x86.avx512reg<zmm30>
// CHECK-IR-LIBXSMM-NEXT:      %172 = x86.dss.addpd %155, %167 : (!x86.avx512reg<zmm21>, !x86.avx512reg<zmm31>) -> !x86.avx512reg<zmm31>
// CHECK-IR-LIBXSMM-NEXT:      %173 = x86.dss.addpd %157, %168 : (!x86.avx512reg<zmm12>, !x86.avx512reg<zmm27>) -> !x86.avx512reg<zmm27>
// CHECK-IR-LIBXSMM-NEXT:      %174 = x86.dss.addpd %158, %169 : (!x86.avx512reg<zmm13>, !x86.avx512reg<zmm28>) -> !x86.avx512reg<zmm28>
// CHECK-IR-LIBXSMM-NEXT:      %175 = x86.dss.addpd %159, %170 : (!x86.avx512reg<zmm14>, !x86.avx512reg<zmm29>) -> !x86.avx512reg<zmm29>
// CHECK-IR-LIBXSMM-NEXT:      %176 = x86.dss.addpd %160, %171 : (!x86.avx512reg<zmm15>, !x86.avx512reg<zmm30>) -> !x86.avx512reg<zmm30>
// CHECK-IR-LIBXSMM-NEXT:      %177 = x86.dss.addpd %161, %172 : (!x86.avx512reg<zmm16>, !x86.avx512reg<zmm31>) -> !x86.avx512reg<zmm31>
// CHECK-IR-LIBXSMM-NEXT:      x86.msk.vmovupd[%23], %173, %27 : (!x86.reg64<rdx>, !x86.avx512reg<zmm27>, !x86.avx512maskreg<k1>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.msk.vmovupd[%23 + 56], %174, %27 : (!x86.reg64<rdx>, !x86.avx512reg<zmm28>, !x86.avx512maskreg<k1>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.msk.vmovupd[%23 + 112], %175, %27 : (!x86.reg64<rdx>, !x86.avx512reg<zmm29>, !x86.avx512maskreg<k1>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.msk.vmovupd[%23 + 168], %176, %27 : (!x86.reg64<rdx>, !x86.avx512reg<zmm30>, !x86.avx512maskreg<k1>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.msk.vmovupd[%23 + 224], %177, %27 : (!x86.reg64<rdx>, !x86.avx512reg<zmm31>, !x86.avx512maskreg<k1>) -> ()
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %180 : !x86.rflags<rflags>, ^bb1(%179 : !x86.reg64<rdi>, %162 : !x86.reg64<rsi>, %178 : !x86.reg64<rdx>, %24 : !x86.reg64<rbp>, %25 : !x86.reg64<rsp>, %26 : !x86.reg64<r11>, %27 : !x86.avx512maskreg<k1>, %29 : !x86.reg64<r10>), ^bb2(%179 : !x86.reg64<rdi>, %162 : !x86.reg64<rsi>, %178 : !x86.reg64<rdx>, %24 : !x86.reg64<rbp>, %25 : !x86.reg64<rsp>, %26 : !x86.reg64<r11>, %27 : !x86.avx512maskreg<k1>, %29 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb2(%181: !x86.reg64<rdi>, %182: !x86.reg64<rsi>, %183: !x86.reg64<rdx>, %184: !x86.reg64<rbp>, %185: !x86.reg64<rsp>, %186: !x86.reg64<r11>, %187: !x86.avx512maskreg<k1>, %188: !x86.reg64<r10>):
