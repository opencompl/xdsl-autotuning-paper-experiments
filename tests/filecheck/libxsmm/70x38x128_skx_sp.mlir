// RUN: libxsmm-gemm dense %t matmul 70 38 128 70 128 70 1 1 1 1 skx nopf SP && xdsl-opt %t -f mlir | filecheck %s
// RUN: libxsmm-gemm dense %t matmul 70 38 128 70 128 70 1 1 1 1 skx nopf SP && xdsl-opt %t -f mlir -p x86-prologue-epilogue-insertion -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-LIBXSMM
// RUN: compxsmm-gemm dense %t matmul 70 38 128 70 128 70 1 1 1 1 skx nopf SP && xdsl-opt %t -f mlir -p COMPXSMM_MANUAL_REGALLOC_PIPELINE -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-COMPXSMM
...
// CHECK-LIBXSMM-NEXT:      mov r10, 0
// CHECK-LIBXSMM-NEXT:  [[SCF_M_BODY_2:^\S+]]:
// CHECK-LIBXSMM-NEXT:      add r10, 64
...
// CHECK-LIBXSMM-NEXT:     sub rdi, 35584
// CHECK-LIBXSMM-NEXT:      cmp r10, 64
// CHECK-LIBXSMM-NEXT:      jl [[SCF_M_BODY_2]]
// CHECK-MANUAL-NEXT:      mov r15, 63
// CHECK-MANUAL-NEXT:      kmovw k1, r15d
// CHECK-LIBXSMM-NEXT:     mov r10, 64
// CHECK-LIBXSMM-NEXT:  [[SCF_M_BODY_3:^\S+]]:
// CHECK-LIBXSMM-NEXT:      add r10, 6
...
// CHECK-LIBXSMM-NEXT:     sub rdi, 35816
// CHECK-LIBXSMM-NEXT:     cmp r10, 70
// CHECK-LIBXSMM-NEXT:      jl [[SCF_M_BODY_3]]
