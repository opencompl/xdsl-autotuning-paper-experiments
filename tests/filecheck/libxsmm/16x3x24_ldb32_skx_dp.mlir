// RUN: libxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
// RUN: libxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir | filecheck %s --check-prefix CHECK-IR-LIBXSMM
// RUN: compxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,convert-x86-scf-to-x86,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// CHECK-IR-LIBXSMM-NEXT:      %54 = x86.dm.vbroadcastsd [%35 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %57 = x86.dm.vbroadcastsd [%35 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %67 = x86.dm.vbroadcastsd [%58 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %80 = x86.dm.vbroadcastsd [%71 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %93 = x86.dm.vbroadcastsd [%84 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %116 = x86.ri.sub %103, 192 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-IR-LIBXSMM-NEXT:      %118 = x86.ri.sub %102, 2944 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
...
// CHECK-IR-LIBXSMM-NEXT:      %128 = x86.ri.add %121, 768 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
