// RUN: libxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir | filecheck %s
// RUN: libxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-prologue-epilogue-insertion -t x86-asm | filecheck %s --check-prefix CHECK-MANUAL
// RUN: compxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p COMPXSMM_MANUAL_REGALLOC_PIPELINE -t x86-asm | filecheck %s --check-prefix CHECK-MANUAL
// RUN: compxsmm-gemm dense %t matmul_bac 16 3 24 16 32 16 1 1 1 1 skx nopf DP --disable-regalloc && xdsl-opt %t -f mlir -p COMPXSMM_AUTO_REGALLOC_PIPELINE -t x86-asm | filecheck %s --check-prefix CHECK-REGALLOC
...
// CHECK-NEXT:      %54 = x86.dm.vbroadcastsd [%35 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %57 = x86.dm.vbroadcastsd [%35 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %67 = x86.dm.vbroadcastsd [%58 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %70 = x86.dm.vbroadcastsd [%58 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %80 = x86.dm.vbroadcastsd [%71 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %83 = x86.dm.vbroadcastsd [%71 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %93 = x86.dm.vbroadcastsd [%84 + 256] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %96 = x86.dm.vbroadcastsd [%84 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      %116 = x86.ri.sub %103, 192 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-NEXT:      %118 = x86.ri.sub %102, 2944 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
...
// CHECK-NEXT:      %128 = x86.ri.add %121, 768 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-REGALLOC-NEXT:      add rsi, 768
