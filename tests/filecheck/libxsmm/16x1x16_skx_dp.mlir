...
// CHECK-IR-LIBXSMM-NEXT:      %141 = x86.ri.sub %137, 128 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-IR-LIBXSMM-NEXT:      %142 = x86.ri.add %21, 128 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %143 = x86.ri.sub %138, 1920 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %144 = x86.si.cmp %26, 16 : (!x86.reg64<r10>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %144 : !x86.rflags<rflags>, ^bb2(%143 : !x86.reg64<rdi>, %141 : !x86.reg64<rsi>, %142 : !x86.reg64<rdx>, %22 : !x86.reg64<rbp>, %23 : !x86.reg64<rsp>, %24 : !x86.reg64<r11>, %26 : !x86.reg64<r10>), ^bb3(%143 : !x86.reg64<rdi>, %141 : !x86.reg64<rsi>, %142 : !x86.reg64<rdx>, %22 : !x86.reg64<rbp>, %23 : !x86.reg64<rsp>, %24 : !x86.reg64<r11>, %26 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb3(%145: !x86.reg64<rdi>, %146: !x86.reg64<rsi>, %147: !x86.reg64<rdx>, %148: !x86.reg64<rbp>, %149: !x86.reg64<rsp>, %150: !x86.reg64<r11>, %151: !x86.reg64<r10>):
// CHECK-IR-LIBXSMM-NEXT:      %152 = x86.ri.add %147, 0 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %153 = x86.ri.add %146, 128 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      %154 = x86.ri.sub %145, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %155 = x86.si.cmp %150, 1 : (!x86.reg64<r11>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %155 : !x86.rflags<rflags>, ^bb1(%154 : !x86.reg64<rdi>, %153 : !x86.reg64<rsi>, %152 : !x86.reg64<rdx>, %148 : !x86.reg64<rbp>, %149 : !x86.reg64<rsp>, %150 : !x86.reg64<r11>), ^bb4(%154 : !x86.reg64<rdi>, %153 : !x86.reg64<rsi>, %152 : !x86.reg64<rdx>, %148 : !x86.reg64<rbp>, %149 : !x86.reg64<rsp>, %150 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb4(%156: !x86.reg64<rdi>, %157: !x86.reg64<rsi>, %158: !x86.reg64<rdx>, %159: !x86.reg64<rbp>, %160: !x86.reg64<rsp>, %161: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %162 = x86.ds.mov %159 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-IR-LIBXSMM-NEXT:      %163, %164 = x86.d.pop %162 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
