// RUN: libxsmm-gemm dense %t matmul 34 5 16 34 16 34 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir | filecheck %s
// RUN: libxsmm-gemm dense %t matmul 34 5 16 34 16 34 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-prologue-epilogue-insertion -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-LIBXSMM
// RUN: compxsmm-gemm dense %t matmul 34 5 16 34 16 34 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p COMPXSMM_MANUAL_REGALLOC_PIPELINE -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-COMPXSMM
...
// CHECK-COMPXSMM-NEXT:    sub rdi, 4336
// CHECK-COMPXSMM-NEXT:    sub rsi, 128
// CHECK-MANUAL-NEXT:      add rdx, 16
// CHECK-LIBXSMM-NEXT:     sub rdi, 4336
// CHECK-LIBXSMM-NEXT:     cmp r10, 34
