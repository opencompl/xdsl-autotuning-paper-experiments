...
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb2(%11 : !x86.reg64<rdi>, %12 : !x86.reg64<rsi>, %13 : !x86.reg64<rdx>, %14 : !x86.reg64<rbp>, %15 : !x86.reg64<rsp>, %17 : !x86.reg64<r11>, %20 : !x86.reg64<r10>, %19 : !x86.avx512maskreg<k1>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb2(%21: !x86.reg64<rdi>, %22: !x86.reg64<rsi>, %23: !x86.reg64<rdx>, %24: !x86.reg64<rbp>, %25: !x86.reg64<rsp>, %26: !x86.reg64<r11>, %27: !x86.reg64<r10>, %28: !x86.avx512maskreg<k1>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %270 : !x86.rflags<rflags>, ^bb2(%269 : !x86.reg64<rdi>, %267 : !x86.reg64<rsi>, %268 : !x86.reg64<rdx>, %237 : !x86.reg64<rbp>, %238 : !x86.reg64<rsp>, %239 : !x86.reg64<r11>, %240 : !x86.reg64<r10>, %241 : !x86.avx512maskreg<k1>), ^bb5(%269 : !x86.reg64<rdi>, %267 : !x86.reg64<rsi>, %268 : !x86.reg64<rdx>, %237 : !x86.reg64<rbp>, %238 : !x86.reg64<rsp>, %239 : !x86.reg64<r11>, %240 : !x86.reg64<r10>, %241 : !x86.avx512maskreg<k1>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb5(%271: !x86.reg64<rdi>, %272: !x86.reg64<rsi>, %273: !x86.reg64<rdx>, %274: !x86.reg64<rbp>, %275: !x86.reg64<rsp>, %276: !x86.reg64<r11>, %277: !x86.reg64<r10>, %278: !x86.avx512maskreg<k1>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %282 : !x86.rflags<rflags>, ^bb1(%281 : !x86.reg64<rdi>, %280 : !x86.reg64<rsi>, %279 : !x86.reg64<rdx>, %274 : !x86.reg64<rbp>, %275 : !x86.reg64<rsp>, %276 : !x86.reg64<r11>), ^bb6(%281 : !x86.reg64<rdi>, %280 : !x86.reg64<rsi>, %279 : !x86.reg64<rdx>, %274 : !x86.reg64<rbp>, %275 : !x86.reg64<rsp>, %276 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb6(%283: !x86.reg64<rdi>, %284: !x86.reg64<rsi>, %285: !x86.reg64<rdx>, %286: !x86.reg64<rbp>, %287: !x86.reg64<rsp>, %288: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %289 = x86.di.mov 18 : () -> !x86.reg64<r11>
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb7(%283 : !x86.reg64<rdi>, %284 : !x86.reg64<rsi>, %285 : !x86.reg64<rdx>, %286 : !x86.reg64<rbp>, %287 : !x86.reg64<rsp>, %289 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb7(%290: !x86.reg64<rdi>, %291: !x86.reg64<rsi>, %292: !x86.reg64<rdx>, %293: !x86.reg64<rbp>, %294: !x86.reg64<rsp>, %295: !x86.reg64<r11>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb8(%290 : !x86.reg64<rdi>, %291 : !x86.reg64<rsi>, %292 : !x86.reg64<rdx>, %293 : !x86.reg64<rbp>, %294 : !x86.reg64<rsp>, %296 : !x86.reg64<r11>, %299 : !x86.reg64<r10>, %298 : !x86.avx512maskreg<k1>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb8(%300: !x86.reg64<rdi>, %301: !x86.reg64<rsi>, %302: !x86.reg64<rdx>, %303: !x86.reg64<rbp>, %304: !x86.reg64<rsp>, %305: !x86.reg64<r11>, %306: !x86.reg64<r10>, %307: !x86.avx512maskreg<k1>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %517 : !x86.rflags<rflags>, ^bb8(%516 : !x86.reg64<rdi>, %514 : !x86.reg64<rsi>, %515 : !x86.reg64<rdx>, %488 : !x86.reg64<rbp>, %489 : !x86.reg64<rsp>, %490 : !x86.reg64<r11>, %491 : !x86.reg64<r10>, %492 : !x86.avx512maskreg<k1>), ^bb11(%516 : !x86.reg64<rdi>, %514 : !x86.reg64<rsi>, %515 : !x86.reg64<rdx>, %488 : !x86.reg64<rbp>, %489 : !x86.reg64<rsp>, %490 : !x86.reg64<r11>, %491 : !x86.reg64<r10>, %492 : !x86.avx512maskreg<k1>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb11(%518: !x86.reg64<rdi>, %519: !x86.reg64<rsi>, %520: !x86.reg64<rdx>, %521: !x86.reg64<rbp>, %522: !x86.reg64<rsp>, %523: !x86.reg64<r11>, %524: !x86.reg64<r10>, %525: !x86.avx512maskreg<k1>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %529 : !x86.rflags<rflags>, ^bb7(%528 : !x86.reg64<rdi>, %527 : !x86.reg64<rsi>, %526 : !x86.reg64<rdx>, %521 : !x86.reg64<rbp>, %522 : !x86.reg64<rsp>, %523 : !x86.reg64<r11>), ^bb12(%528 : !x86.reg64<rdi>, %527 : !x86.reg64<rsi>, %526 : !x86.reg64<rdx>, %521 : !x86.reg64<rbp>, %522 : !x86.reg64<rsp>, %523 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb12(%530: !x86.reg64<rdi>, %531: !x86.reg64<rsi>, %532: !x86.reg64<rdx>, %533: !x86.reg64<rbp>, %534: !x86.reg64<rsp>, %535: !x86.reg64<r11>):
