// RUN: libxsmm-gemm dense %t matmul 16 29 16 16 16 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir | filecheck %s
// RUN: libxsmm-gemm dense %t matmul 16 29 16 16 16 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-prologue-epilogue-insertion -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-LIBXSMM
// RUN: compxsmm-gemm dense %t matmul 16 29 16 16 16 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p COMPXSMM_MANUAL_REGALLOC_PIPELINE -t x86-asm | filecheck %s --check-prefixes CHECK-MANUAL,CHECK-COMPXSMM
...
// CHECK-COMPXSMM-NEXT:    sub rdi, 1920
// CHECK-COMPXSMM-NEXT:    sub rsi, 128
// CHECK-MANUAL-NEXT:      add rdx, 128
// CHECK-LIBXSMM-NEXT:     sub rdi, 1920
...
// CHECK-LIBXSMM-NEXT:  [[SCF_N_BODY_1:^\S+]]:
// CHECK-LIBXSMM-NEXT:      add r11, 9
// CHECK-LIBXSMM-NEXT:      mov r10, 0
...
// CHECK-LIBXSMM-NEXT:      jl [[SCF_N_BODY_1]]
