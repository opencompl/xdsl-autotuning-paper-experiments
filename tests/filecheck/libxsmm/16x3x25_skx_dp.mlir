// RUN: libxsmm-gemm dense %t matmul_bac 16 3 25 16 25 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
// RUN: libxsmm-gemm dense %t matmul_bac 16 3 25 16 25 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir | filecheck %s --check-prefix CHECK-IR-LIBXSMM
// RUN: compxsmm-gemm dense %t matmul_bac 16 3 25 16 25 16 1 1 1 1 skx nopf DP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// CHECK-IR-LIBXSMM-NEXT:    ^bb2(%34: !x86.reg64<rdi>, %35: !x86.reg64<rsi>, %36: !x86.reg64<rdx>, %37: !x86.reg64<rbp>, %38: !x86.reg64<rsp>, %39: !x86.reg64<r11>, %40: !x86.reg64<r10>, %41: !x86.avx512reg<zmm26>, %42: !x86.avx512reg<zmm27>, %43: !x86.avx512reg<zmm28>, %44: !x86.avx512reg<zmm29>, %45: !x86.avx512reg<zmm30>, %46: !x86.avx512reg<zmm31>, %47: !x86.reg64<r12>):
...
// CHECK-IR-LIBXSMM-NEXT:      %54 = x86.dm.vbroadcastsd [%35 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %57 = x86.dm.vbroadcastsd [%35 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %67 = x86.dm.vbroadcastsd [%58 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %70 = x86.dm.vbroadcastsd [%58 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %80 = x86.dm.vbroadcastsd [%71 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %83 = x86.dm.vbroadcastsd [%71 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %93 = x86.dm.vbroadcastsd [%84 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %96 = x86.dm.vbroadcastsd [%84 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-IR-LIBXSMM-NEXT:      %101 = x86.si.cmp %48, 24 : (!x86.reg64<r12>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %101 : !x86.rflags<rflags>, ^bb2(%98 : !x86.reg64<rdi>, %97 : !x86.reg64<rsi>, %36 : !x86.reg64<rdx>, %37 : !x86.reg64<rbp>, %38 : !x86.reg64<rsp>, %39 : !x86.reg64<r11>, %40 : !x86.reg64<r10>, %91 : !x86.avx512reg<zmm26>, %92 : !x86.avx512reg<zmm27>, %94 : !x86.avx512reg<zmm28>, %95 : !x86.avx512reg<zmm29>, %99 : !x86.avx512reg<zmm30>, %100 : !x86.avx512reg<zmm31>, %48 : !x86.reg64<r12>), ^bb3(%98 : !x86.reg64<rdi>, %97 : !x86.reg64<rsi>, %36 : !x86.reg64<rdx>, %37 : !x86.reg64<rbp>, %38 : !x86.reg64<rsp>, %39 : !x86.reg64<r11>, %40 : !x86.reg64<r10>, %91 : !x86.avx512reg<zmm26>, %92 : !x86.avx512reg<zmm27>, %94 : !x86.avx512reg<zmm28>, %95 : !x86.avx512reg<zmm29>, %99 : !x86.avx512reg<zmm30>, %100 : !x86.avx512reg<zmm31>, %48 : !x86.reg64<r12>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb3(%102: !x86.reg64<rdi>, %103: !x86.reg64<rsi>, %104: !x86.reg64<rdx>, %105: !x86.reg64<rbp>, %106: !x86.reg64<rsp>, %107: !x86.reg64<r11>, %108: !x86.reg64<r10>, %109: !x86.avx512reg<zmm26>, %110: !x86.avx512reg<zmm27>, %111: !x86.avx512reg<zmm28>, %112: !x86.avx512reg<zmm29>, %113: !x86.avx512reg<zmm30>, %114: !x86.avx512reg<zmm31>, %115: !x86.reg64<r12>):
// CHECK-IR-LIBXSMM-NEXT:      %116 = x86.dm.vmovapd [%102] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-IR-LIBXSMM-NEXT:      %117 = x86.dm.vmovapd [%102 + 64] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-IR-LIBXSMM-NEXT:      %118 = x86.dm.vbroadcastsd [%103] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-IR-LIBXSMM-NEXT:      %119 = x86.rss.vfmadd231pd %109, %116, %118 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm26>
// CHECK-IR-LIBXSMM-NEXT:      %120 = x86.rss.vfmadd231pd %110, %117, %118 : (!x86.avx512reg<zmm27>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm27>
// CHECK-IR-LIBXSMM-NEXT:      %121 = x86.dm.vbroadcastsd [%103 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-IR-LIBXSMM-NEXT:      %122 = x86.rss.vfmadd231pd %111, %116, %121 : (!x86.avx512reg<zmm28>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm28>
// CHECK-IR-LIBXSMM-NEXT:      %123 = x86.rss.vfmadd231pd %112, %117, %121 : (!x86.avx512reg<zmm29>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm29>
// CHECK-IR-LIBXSMM-NEXT:      %124 = x86.dm.vbroadcastsd [%103 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-IR-LIBXSMM-NEXT:      %125 = x86.ri.add %103, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      %126 = x86.ri.add %102, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %127 = x86.rss.vfmadd231pd %113, %116, %124 : (!x86.avx512reg<zmm30>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm30>
// CHECK-IR-LIBXSMM-NEXT:      %128 = x86.rss.vfmadd231pd %114, %117, %124 : (!x86.avx512reg<zmm31>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm31>
// CHECK-IR-LIBXSMM-NEXT:      %129 = x86.ri.sub %125, 200 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104], %119 : (!x86.reg64<rdx>, !x86.avx512reg<zmm26>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104 + 64], %120 : (!x86.reg64<rdx>, !x86.avx512reg<zmm27>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104 + 128], %122 : (!x86.reg64<rdx>, !x86.avx512reg<zmm28>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104 + 192], %123 : (!x86.reg64<rdx>, !x86.avx512reg<zmm29>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104 + 256], %127 : (!x86.reg64<rdx>, !x86.avx512reg<zmm30>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      x86.ms.vmovapd [%104 + 320], %128 : (!x86.reg64<rdx>, !x86.avx512reg<zmm31>) -> ()
// CHECK-IR-LIBXSMM-NEXT:      %130 = x86.ri.add %104, 128 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %131 = x86.ri.sub %126, 3072 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %132 = x86.si.cmp %108, 16 : (!x86.reg64<r10>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %132 : !x86.rflags<rflags>, ^bb1(%131 : !x86.reg64<rdi>, %129 : !x86.reg64<rsi>, %130 : !x86.reg64<rdx>, %105 : !x86.reg64<rbp>, %106 : !x86.reg64<rsp>, %107 : !x86.reg64<r11>, %108 : !x86.reg64<r10>), ^bb4(%131 : !x86.reg64<rdi>, %129 : !x86.reg64<rsi>, %130 : !x86.reg64<rdx>, %105 : !x86.reg64<rbp>, %106 : !x86.reg64<rsp>, %107 : !x86.reg64<r11>, %108 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb4(%133: !x86.reg64<rdi>, %134: !x86.reg64<rsi>, %135: !x86.reg64<rdx>, %136: !x86.reg64<rbp>, %137: !x86.reg64<rsp>, %138: !x86.reg64<r11>, %139: !x86.reg64<r10>):
// CHECK-IR-LIBXSMM-NEXT:      %140 = x86.ri.add %135, 256 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-IR-LIBXSMM-NEXT:      %141 = x86.ri.add %134, 600 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-IR-LIBXSMM-NEXT:      %142 = x86.ri.sub %133, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-IR-LIBXSMM-NEXT:      %143 = x86.si.cmp %138, 3 : (!x86.reg64<r11>) -> !x86.rflags<rflags>
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %143 : !x86.rflags<rflags>, ^bb0(%142 : !x86.reg64<rdi>, %141 : !x86.reg64<rsi>, %140 : !x86.reg64<rdx>, %136 : !x86.reg64<rbp>, %137 : !x86.reg64<rsp>, %138 : !x86.reg64<r11>), ^bb5(%142 : !x86.reg64<rdi>, %141 : !x86.reg64<rsi>, %140 : !x86.reg64<rdx>, %136 : !x86.reg64<rbp>, %137 : !x86.reg64<rsp>, %138 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb5(%144: !x86.reg64<rdi>, %145: !x86.reg64<rsi>, %146: !x86.reg64<rdx>, %147: !x86.reg64<rbp>, %148: !x86.reg64<rsp>, %149: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %150 = x86.ds.mov %147 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-IR-LIBXSMM-NEXT:      %151, %152 = x86.d.pop %150 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
