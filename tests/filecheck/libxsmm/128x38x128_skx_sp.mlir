// RUN: libxsmm-gemm dense %t matmul_bac 128 38 128  128 128 128  1 1  1 1  skx  nopf  SP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// RUN: compxsmm-gemm dense %t matmul_bac 128 38 128  128 128 128  1 1  1 1  skx  nopf  SP && xdsl-opt %t -f mlir -p x86-regalloc-verify-liveness,x86-prologue-epilogue-insertion -t x86-asm | filecheck %s
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %276 : !x86.rflags<rflags>, ^bb0(%275 : !x86.reg64<rdi>, %274 : !x86.reg64<rsi>, %273 : !x86.reg64<rdx>, %269 : !x86.reg64<rbp>, %270 : !x86.reg64<rsp>, %271 : !x86.reg64<r11>), ^bb5(%275 : !x86.reg64<rdi>, %274 : !x86.reg64<rsi>, %273 : !x86.reg64<rdx>, %269 : !x86.reg64<rbp>, %270 : !x86.reg64<rsp>, %271 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb5(%277: !x86.reg64<rdi>, %278: !x86.reg64<rsi>, %279: !x86.reg64<rdx>, %280: !x86.reg64<rbp>, %281: !x86.reg64<rsp>, %282: !x86.reg64<r11>):
// CHECK-IR-LIBXSMM-NEXT:      %283 = x86.di.mov 18 : () -> !x86.reg64<r11>
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb6(%277 : !x86.reg64<rdi>, %278 : !x86.reg64<rsi>, %279 : !x86.reg64<rdx>, %280 : !x86.reg64<rbp>, %281 : !x86.reg64<rsp>, %283 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb6(%284: !x86.reg64<rdi>, %285: !x86.reg64<rsi>, %286: !x86.reg64<rdx>, %287: !x86.reg64<rbp>, %288: !x86.reg64<rsp>, %289: !x86.reg64<r11>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.fallthrough ^bb7(%284 : !x86.reg64<rdi>, %285 : !x86.reg64<rsi>, %286 : !x86.reg64<rdx>, %287 : !x86.reg64<rbp>, %288 : !x86.reg64<rsp>, %290 : !x86.reg64<r11>, %291 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb7(%292: !x86.reg64<rdi>, %293: !x86.reg64<rsi>, %294: !x86.reg64<rdx>, %295: !x86.reg64<rbp>, %296: !x86.reg64<rsp>, %297: !x86.reg64<r11>, %298: !x86.reg64<r10>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %506 : !x86.rflags<rflags>, ^bb7(%505 : !x86.reg64<rdi>, %503 : !x86.reg64<rsi>, %504 : !x86.reg64<rdx>, %478 : !x86.reg64<rbp>, %479 : !x86.reg64<rsp>, %480 : !x86.reg64<r11>, %481 : !x86.reg64<r10>), ^bb10(%505 : !x86.reg64<rdi>, %503 : !x86.reg64<rsi>, %504 : !x86.reg64<rdx>, %478 : !x86.reg64<rbp>, %479 : !x86.reg64<rsp>, %480 : !x86.reg64<r11>, %481 : !x86.reg64<r10>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb10(%507: !x86.reg64<rdi>, %508: !x86.reg64<rsi>, %509: !x86.reg64<rdx>, %510: !x86.reg64<rbp>, %511: !x86.reg64<rsp>, %512: !x86.reg64<r11>, %513: !x86.reg64<r10>):
...
// CHECK-IR-LIBXSMM-NEXT:      x86.c.jl %517 : !x86.rflags<rflags>, ^bb6(%516 : !x86.reg64<rdi>, %515 : !x86.reg64<rsi>, %514 : !x86.reg64<rdx>, %510 : !x86.reg64<rbp>, %511 : !x86.reg64<rsp>, %512 : !x86.reg64<r11>), ^bb11(%516 : !x86.reg64<rdi>, %515 : !x86.reg64<rsi>, %514 : !x86.reg64<rdx>, %510 : !x86.reg64<rbp>, %511 : !x86.reg64<rsp>, %512 : !x86.reg64<r11>)
// CHECK-IR-LIBXSMM-NEXT:    ^bb11(%518: !x86.reg64<rdi>, %519: !x86.reg64<rsi>, %520: !x86.reg64<rdx>, %521: !x86.reg64<rbp>, %522: !x86.reg64<rsp>, %523: !x86.reg64<r11>):
