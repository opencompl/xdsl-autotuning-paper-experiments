...
// CHECK-NEXT:     %a_out, %b_out, %acc_out = xsmm.matmul_reg %a, %b {m = 8 : i64, n = 1 : i64, k = 23 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true, test_tile_size = 23 : i64} outs(%acc : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
...
x86_func.func @below_threshold(
  ...
  %a_out, %b_out, %acc_out = xsmm.matmul_reg %a, %b {m = 8 : i64, n = 1 : i64, k = 23 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true, test_tile_size = 23 : i64} outs(%acc : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
  x86_func.ret
}
...
// CHECK-NEXT:       %6, %7, %8 = xsmm.matmul_reg %3, %4 {m = 8 : i64, n = 1 : i64, k = 4 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true} outs(%5 : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
...
// CHECK-NEXT:       %9, %10, %11 = xsmm.matmul_reg %6, %7 {m = 8 : i64, n = 1 : i64, k = 4 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true} outs(%8 : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
// CHECK-NEXT:       x86_scf.yield %9, %10, %11 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.avx512reg<zmm31>
// CHECK-NEXT:     }
// CHECK-NEXT:     %a_out, %b_out, %acc_out = xsmm.matmul_reg %2, %3 {m = 8 : i64, n = 1 : i64, k = 1 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true} outs(%4 : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
// CHECK-NEXT:     x86_func.ret
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:     %0 = x86.di.mov 0 : () -> !x86.reg64
// CHECK-NEXT:     %1, %a_out, %b_out, %acc_out = x86_scf.for %2 : !x86.reg64  = %0 to 24 : si32 step 4 : si32 iter_args(%3 = %a, %4 = %b, %5 = %acc) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.avx512reg<zmm31>) {
// CHECK-NEXT:       %6, %7, %8 = xsmm.matmul_reg %3, %4 {m = 7 : i64, n = 1 : i64, k = 4 : i64, lda = 7 : i64, ldb = 32 : i64, datatype = f64, aligned_a = false} ins(%mask : !x86.avx512maskreg<k1>) outs(%5 : !x86.avx512reg<zmm31>) : (!x86.reg64<rdi>, !x86.reg64<rsi>)
// CHECK-NEXT:       x86_scf.yield %6, %7, %8 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.avx512reg<zmm31>
// CHECK-NEXT:     }
// CHECK-NEXT:     x86_func.ret
// CHECK-NEXT:   }
