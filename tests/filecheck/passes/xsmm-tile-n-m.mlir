...
// CHECK-NEXT:      %0 = x86.di.mov 4 : () -> !x86.reg64<r11>
// CHECK-NEXT:      %1, %2, %3, %4, %5, %6, %7 = x86_scf.for %8 : !x86.reg64<r11>  = %0 to 32 : si32 step 14 : si32 iter_args(%9 = %a, %10 = %b, %11 = %c, %12 = %rbp, %13 = %rsp, %14 = %state) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.reg64<r8>) {
...
// CHECK-NEXT:          %80, %81, %82, %83, %84 = "xsmm.matmul"(%75, %76, %77, %78, %79) <{m = 64 : i64, n_start = 18 : i64, n = 5 : i64, k = 128 : i64, lda = 70 : i64, ldb = 128 : i64, ldc = 70 : i64, datatype = f32, aligned_a = false, aligned_c = false, iterator = "m", operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>}> : (!x86.reg64, !x86.reg64, !x86.reg64, !x86.reg64, !x86.reg64) -> (!x86.reg64, !x86.reg64, !x86.reg64, !x86.reg64, !x86.reg64)
