...
// CHECK-NEXT:     %0, %1, %2 = "xsmm.matmul"(%a, %b, %c) <{m = 16 : i64, n = 12 : i64, k = 16 : i64, lda = 16 : i64, ldb = 16 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true, iterator = "n", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
// CHECK-NEXT:     %a_out, %b_out, %c_out = "xsmm.matmul"(%0, %1, %2) <{m = 16 : i64, n = 10 : i64, k = 16 : i64, lda = 16 : i64, ldb = 16 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true, iterator = "n", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
// CHECK-NEXT:     x86_func.ret
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:       %9, %10, %11 = "xsmm.matmul"(%6, %7, %8) <{m = 8 : i64, n = 2 : i64, k = 5 : i64, lda = 17 : i64, ldb = 5 : i64, ldc = 17 : i64, datatype = f64, aligned_a = false, aligned_c = false, iterator = "m", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
// CHECK-NEXT:       x86_scf.yield %9, %10, %11 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>
// CHECK-NEXT:     }
// CHECK-NEXT:     %a_out, %b_out, %c_out = "xsmm.matmul"(%2, %3, %4) <{m = 1 : i64, n = 2 : i64, k = 5 : i64, lda = 17 : i64, ldb = 5 : i64, ldc = 17 : i64, datatype = f64, aligned_a = false, aligned_c = false, iterator = "m", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
// CHECK-NEXT:     x86_func.ret
// CHECK-NEXT:   }
// CHECK-NEXT: }
