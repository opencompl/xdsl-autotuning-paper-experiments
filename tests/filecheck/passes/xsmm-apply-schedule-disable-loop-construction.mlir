...
x86_func.func @unmasked(
  ...
  %a_out, %b_out, %c_out = "xsmm.matmul"(%a, %b, %c) <{m = 8 : i64, n = 1 : i64, k = 24 : i64, lda = 8 : i64, ldb = 24 : i64, ldc = 8 : i64, datatype = f64, aligned_a = true, aligned_c = true, iterator = "n", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
  x86_func.ret
}
...
x86_func.func @masked(
  ...
  %a_out, %b_out, %c_out = "xsmm.matmul"(%a, %b, %c) <{m = 7 : i64, n = 1 : i64, k = 1 : i64, lda = 7 : i64, ldb = 1 : i64, ldc = 7 : i64, datatype = f64, aligned_a = false, aligned_c = false, iterator = "n", operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>)
  x86_func.ret
}
