...
// CHECK-NEXT:    %a_out, %b_out, %rbp_out, %rsp_out, %acc0_out, %acc1_out = "xsmm.matmul_reg"(%a, %b, %rbp, %rsp, %acc0, %acc1) <{m = 8 : i64, n = 2 : i64, k = 4 : i64, lda = 8 : i64, ldb = 32 : i64, datatype = f64, aligned_a = true, iterator = "k", operandSegmentSizes = array<i32: 1, 1, 1, 1, 0, 2>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 2>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>)
// CHECK-NEXT:  }
...
// CHECK-NEXT:    %a_out, %b_out, %rbp_out, %rsp_out, %acc0_out, %acc1_out, %acc2_out, %acc3_out = "xsmm.matmul_reg"(%a, %b, %rbp, %rsp, %mask, %acc0, %acc1, %acc2, %acc3) <{m = 17 : i64, n = 2 : i64, k = 3 : i64, lda = 17 : i64, ldb = 24 : i64, datatype = f32, aligned_a = false, iterator = "k", operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 4>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 4>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512maskreg<k1>, !x86.avx512reg<zmm28>, !x86.avx512reg<zmm29>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512reg<zmm28>, !x86.avx512reg<zmm29>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>)
// CHECK-NEXT:  }
...
builtin.module {
  ...
  %a_out, %b_out, %rbp_out, %rsp_out, %acc0_out, %acc1_out, %acc2_out, %acc3_out = "xsmm.matmul_reg"(%a, %b, %rbp, %rsp, %mask, %acc0, %acc1, %acc2, %acc3) <{m = 17 : i64, n = 2 : i64, k = 3 : i64, lda = 17 : i64, ldb = 24 : i64, datatype = f32, aligned_a = false, iterator = "k", operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 4>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 4>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512maskreg<k1>, !x86.avx512reg<zmm28>, !x86.avx512reg<zmm29>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rbp>, !x86.reg64<rsp>, !x86.avx512reg<zmm28>, !x86.avx512reg<zmm29>, !x86.avx512reg<zmm30>, !x86.avx512reg<zmm31>)
}
