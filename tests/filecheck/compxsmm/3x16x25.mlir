...
// CHECK-NEXT:          %69 = x86.dm.vbroadcastsd [%54 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %72 = x86.dm.vbroadcastsd [%54 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %82 = x86.dm.vbroadcastsd [%73 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %85 = x86.dm.vbroadcastsd [%73 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %95 = x86.dm.vbroadcastsd [%86 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %98 = x86.dm.vbroadcastsd [%86 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %108 = x86.dm.vbroadcastsd [%99 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:          %111 = x86.dm.vbroadcastsd [%99 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        %116 = x86.dm.vmovapd [%41] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-NEXT:        %117 = x86.dm.vmovapd [%41 + 64] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-NEXT:        %118 = x86.dm.vbroadcastsd [%42] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %119 = x86.rss.vfmadd231pd %46, %116, %118 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm26>
// CHECK-NEXT:        %120 = x86.rss.vfmadd231pd %47, %117, %118 : (!x86.avx512reg<zmm27>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm27>
// CHECK-NEXT:        %121 = x86.dm.vbroadcastsd [%42 + 200] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %122 = x86.rss.vfmadd231pd %48, %116, %121 : (!x86.avx512reg<zmm28>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm28>
// CHECK-NEXT:        %123 = x86.rss.vfmadd231pd %49, %117, %121 : (!x86.avx512reg<zmm29>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm29>
// CHECK-NEXT:        %124 = x86.dm.vbroadcastsd [%42 + 400] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %125 = x86.ri.add %42, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:        %126 = x86.ri.add %41, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        %127 = x86.rss.vfmadd231pd %50, %116, %124 : (!x86.avx512reg<zmm30>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm30>
// CHECK-NEXT:        %128 = x86.rss.vfmadd231pd %51, %117, %124 : (!x86.avx512reg<zmm31>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm31>
// CHECK-NEXT:        %129 = x86.ri.sub %125, 200 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:        x86.ms.vmovapd [%43], %119 : (!x86.reg64<rdx>, !x86.avx512reg<zmm26>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%43 + 64], %120 : (!x86.reg64<rdx>, !x86.avx512reg<zmm27>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%43 + 128], %122 : (!x86.reg64<rdx>, !x86.avx512reg<zmm28>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%43 + 192], %123 : (!x86.reg64<rdx>, !x86.avx512reg<zmm29>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%43 + 256], %127 : (!x86.reg64<rdx>, !x86.avx512reg<zmm30>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%43 + 320], %128 : (!x86.reg64<rdx>, !x86.avx512reg<zmm31>) -> ()
// CHECK-NEXT:        %130 = x86.ri.add %43, 128 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:        %131 = x86.ri.sub %126, 3072 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        x86_scf.yield %131, %129, %130, %44, %45 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:      }
// CHECK-NEXT:      %132 = x86.ri.add %25, 256 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %133 = x86.ri.add %24, 600 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:      %134 = x86.ri.sub %23, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:      x86_scf.yield %134, %133, %132, %26, %27 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %135 = x86.ds.mov %14 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-NEXT:    %136, %137 = x86.d.pop %135 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
