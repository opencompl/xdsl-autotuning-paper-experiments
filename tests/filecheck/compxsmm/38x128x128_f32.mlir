...
// CHECK-NEXT:      %23, %24, %25, %26, %27 = "xsmm.matmul_n"(%18, %19, %20, %21, %22) <{m = 128 : i64, n_blocking = 6 : i64, k = 128 : i64, lda = 128 : i64, ldb = 128 : i64, ldc = 128 : i64, datatype = f32, aligned_a = true, aligned_c = true}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:      x86_scf.yield %23, %24, %25, %26, %27 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %28 = x86.di.mov 18 : () -> !x86.reg64<r11>
// CHECK-NEXT:    %29, %30, %31, %32, %33, %34 = x86_scf.for %35 : !x86.reg64<r11>  = %28 to 38 : si32 step 5 : si32 iter_args(%36 = %12, %37 = %13, %38 = %14, %39 = %15, %40 = %16) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) {
// CHECK-NEXT:      %41, %42, %43, %44, %45 = "xsmm.matmul_n"(%36, %37, %38, %39, %40) <{m = 128 : i64, n_blocking = 5 : i64, k = 128 : i64, lda = 128 : i64, ldb = 128 : i64, ldc = 128 : i64, datatype = f32, aligned_a = true, aligned_c = true}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:      x86_scf.yield %41, %42, %43, %44, %45 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %46 = x86.ds.mov %33 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-NEXT:    %47, %48 = x86.d.pop %46 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
