...
// CHECK-NEXT:        %36, %37, %38, %39, %40 = "xsmm.matmul_m"(%31, %32, %33, %34, %35) <{m_blocking = 16 : i64, n_blocking = 10 : i64, k = 16 : i64, lda = 16 : i64, ldb = 16 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true, operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:        x86_scf.yield %36, %37, %38, %39, %40 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:      }
// CHECK-NEXT:      %41 = x86.ri.add %27, 1152 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %42 = x86.ri.add %26, 1280 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-NEXT:    }
// CHECK-NEXT:    %44 = x86.di.mov 20 : () -> !x86.reg64<r11>
// CHECK-NEXT:    %45, %46, %47, %48, %49, %50 = x86_scf.for %51 : !x86.reg64<r11>  = %44 to 29 : si32 step 9 : si32 iter_args(%52 = %12, %53 = %13, %54 = %14, %55 = %15, %56 = %16) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) {
...
// CHECK-NEXT:        %70, %71, %72, %73, %74 = "xsmm.matmul_m"(%65, %66, %67, %68, %69) <{m_blocking = 16 : i64, n_blocking = 9 : i64, k = 16 : i64, lda = 16 : i64, ldb = 16 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true, operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:        x86_scf.yield %70, %71, %72, %73, %74 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:      }
// CHECK-NEXT:      %75 = x86.ri.add %61, 1024 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %76 = x86.ri.add %60, 1152 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
