...
// CHECK-NEXT:        %72 = x86.dm.vbroadcastsd [%57 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %75 = x86.dm.vbroadcastsd [%57 + 1024] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %85 = x86.dm.vbroadcastsd [%76 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %88 = x86.dm.vbroadcastsd [%76 + 1024] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %98 = x86.dm.vbroadcastsd [%89 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %101 = x86.dm.vbroadcastsd [%89 + 1024] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %111 = x86.dm.vbroadcastsd [%102 + 512] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %114 = x86.dm.vbroadcastsd [%102 + 1024] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:      }
// CHECK-NEXT:      %119 = x86.ri.sub %45, 512 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
...
// CHECK-NEXT:      %120 = x86.ri.add %46, 128 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %121 = x86.ri.sub %44, 8064 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:      x86_scf.yield %121, %119, %120, %47, %48 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %122 = x86.ri.add %27, 256 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:    %123 = x86.ri.add %26, 1536 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:    %124 = x86.ri.sub %25, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:    x86_scf.yield %124, %123, %122, %28, %29 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:  }
// CHECK-NEXT:  %125 = x86.ds.mov %15 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-NEXT:  %126, %127 = x86.d.pop %125 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
