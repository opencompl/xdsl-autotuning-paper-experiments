...
// CHECK-NEXT:      %23, %24, %25, %26, %27 = "xsmm.matmul_n"(%18, %19, %20, %21, %22) <{m = 16 : i64, n_blocking = 14 : i64, k = 24 : i64, lda = 16 : i64, ldb = 24 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:      x86_scf.yield %23, %24, %25, %26, %27 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %28 = x86.di.mov 14 : () -> !x86.reg64<r11>
// CHECK-NEXT:    %29, %30, %31, %32, %33, %34 = x86_scf.for %35 : !x86.reg64<r11>  = %28 to 66 : si32 step 13 : si32 iter_args(%36 = %12, %37 = %13, %38 = %14, %39 = %15, %40 = %16) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) {
// CHECK-NEXT:      %41, %42, %43, %44, %45 = "xsmm.matmul_n"(%36, %37, %38, %39, %40) <{m = 16 : i64, n_blocking = 13 : i64, k = 24 : i64, lda = 16 : i64, ldb = 24 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
