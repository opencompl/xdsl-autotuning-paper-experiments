...
// CHECK-NEXT:    }
// CHECK-NEXT:    %31 = x86.di.mov 14 : () -> !x86.reg64<r11>
// CHECK-NEXT:    %32, %33, %34, %35, %36, %37 = x86_scf.for %38 : !x86.reg64<r11>  = %31 to 66 : si32 step 13 : si32 iter_args(%39 = %12, %40 = %13, %41 = %14, %42 = %15, %43 = %16) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) {
// CHECK-NEXT:      %44, %45, %46, %47, %48 = "xsmm.matmul_m"(%39, %40, %41, %42, %43) <{m_blocking = 16 : i64, n_blocking = 13 : i64, k = 24 : i64, lda = 16 : i64, ldb = 24 : i64, ldc = 16 : i64, datatype = f64, aligned_a = true, aligned_c = true, operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>, resultSegmentSizes = array<i32: 1, 1, 1, 1, 1, 0>}> : (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>) -> (!x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>)
// CHECK-NEXT:      %49 = x86.ri.add %46, 1536 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %50 = x86.ri.add %45, 2496 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:      %51 = x86.ri.sub %44, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
