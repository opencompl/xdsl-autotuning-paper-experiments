...
// CHECK-NEXT:        %45 = x86.dm.vbroadcastsd [%30 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %48 = x86.dm.vbroadcastsd [%30 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %58 = x86.dm.vbroadcastsd [%49 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %61 = x86.dm.vbroadcastsd [%49 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %71 = x86.dm.vbroadcastsd [%62 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %74 = x86.dm.vbroadcastsd [%62 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %84 = x86.dm.vbroadcastsd [%75 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %87 = x86.dm.vbroadcastsd [%75 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %97 = x86.dm.vbroadcastsd [%88 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %100 = x86.dm.vbroadcastsd [%88 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
...
// CHECK-NEXT:        %105 = x86.dm.vmovapd [%102] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-NEXT:        %106 = x86.dm.vmovapd [%102 + 64] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-NEXT:        %107 = x86.dm.vbroadcastsd [%101] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %108 = x86.rss.vfmadd231pd %95, %105, %107 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm26>
// CHECK-NEXT:        %109 = x86.rss.vfmadd231pd %96, %106, %107 : (!x86.avx512reg<zmm27>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm27>
// CHECK-NEXT:        %110 = x86.dm.vbroadcastsd [%101 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %111 = x86.rss.vfmadd231pd %98, %105, %110 : (!x86.avx512reg<zmm28>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm28>
// CHECK-NEXT:        %112 = x86.rss.vfmadd231pd %99, %106, %110 : (!x86.avx512reg<zmm29>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm29>
// CHECK-NEXT:        %113 = x86.dm.vbroadcastsd [%101 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %114 = x86.ri.add %101, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:        %115 = x86.ri.add %102, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        %116 = x86.rss.vfmadd231pd %103, %105, %113 : (!x86.avx512reg<zmm30>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm30>
// CHECK-NEXT:        %117 = x86.rss.vfmadd231pd %104, %106, %113 : (!x86.avx512reg<zmm31>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm31>
// CHECK-NEXT:        %118 = x86.dm.vmovapd [%115] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-NEXT:        %119 = x86.dm.vmovapd [%115 + 64] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-NEXT:        %120 = x86.dm.vbroadcastsd [%114] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %121 = x86.rss.vfmadd231pd %108, %118, %120 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm26>
// CHECK-NEXT:        %122 = x86.rss.vfmadd231pd %109, %119, %120 : (!x86.avx512reg<zmm27>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm27>
// CHECK-NEXT:        %123 = x86.dm.vbroadcastsd [%114 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %124 = x86.rss.vfmadd231pd %111, %118, %123 : (!x86.avx512reg<zmm28>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm28>
// CHECK-NEXT:        %125 = x86.rss.vfmadd231pd %112, %119, %123 : (!x86.avx512reg<zmm29>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm29>
// CHECK-NEXT:        %126 = x86.dm.vbroadcastsd [%114 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %127 = x86.ri.add %114, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:        %128 = x86.ri.add %115, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        %129 = x86.rss.vfmadd231pd %116, %118, %126 : (!x86.avx512reg<zmm30>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm30>
// CHECK-NEXT:        %130 = x86.rss.vfmadd231pd %117, %119, %126 : (!x86.avx512reg<zmm31>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm31>
// CHECK-NEXT:        %131 = x86.dm.vmovapd [%128] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm1>
// CHECK-NEXT:        %132 = x86.dm.vmovapd [%128 + 64] : (!x86.reg64<rdi>) -> !x86.avx512reg<zmm2>
// CHECK-NEXT:        %133 = x86.dm.vbroadcastsd [%127] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %134 = x86.rss.vfmadd231pd %121, %131, %133 : (!x86.avx512reg<zmm26>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm26>
// CHECK-NEXT:        %135 = x86.rss.vfmadd231pd %122, %132, %133 : (!x86.avx512reg<zmm27>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm27>
// CHECK-NEXT:        %136 = x86.dm.vbroadcastsd [%127 + 64] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %137 = x86.rss.vfmadd231pd %124, %131, %136 : (!x86.avx512reg<zmm28>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm28>
// CHECK-NEXT:        %138 = x86.rss.vfmadd231pd %125, %132, %136 : (!x86.avx512reg<zmm29>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm29>
// CHECK-NEXT:        %139 = x86.dm.vbroadcastsd [%127 + 128] : (!x86.reg64<rsi>) -> !x86.avx512reg<zmm0>
// CHECK-NEXT:        %140 = x86.ri.add %127, 8 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:        %141 = x86.ri.add %128, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        %142 = x86.rss.vfmadd231pd %129, %131, %139 : (!x86.avx512reg<zmm30>, !x86.avx512reg<zmm1>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm30>
// CHECK-NEXT:        %143 = x86.rss.vfmadd231pd %130, %132, %139 : (!x86.avx512reg<zmm31>, !x86.avx512reg<zmm2>, !x86.avx512reg<zmm0>) -> !x86.avx512reg<zmm31>
// CHECK-NEXT:        x86.ms.vmovapd [%31], %134 : (!x86.reg64<rdx>, !x86.avx512reg<zmm26>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%31 + 64], %135 : (!x86.reg64<rdx>, !x86.avx512reg<zmm27>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%31 + 128], %137 : (!x86.reg64<rdx>, !x86.avx512reg<zmm28>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%31 + 192], %138 : (!x86.reg64<rdx>, !x86.avx512reg<zmm29>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%31 + 256], %142 : (!x86.reg64<rdx>, !x86.avx512reg<zmm30>) -> ()
// CHECK-NEXT:        x86.ms.vmovapd [%31 + 320], %143 : (!x86.reg64<rdx>, !x86.avx512reg<zmm31>) -> ()
// CHECK-NEXT:        %144 = x86.ri.add %31, 128 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:        %145 = x86.ri.sub %141, 896 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:        x86_scf.yield %145, %140, %144, %32, %33 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:      }
// CHECK-NEXT:      %146 = x86.ri.add %25, 256 : (!x86.reg64<rdx>) -> !x86.reg64<rdx>
// CHECK-NEXT:      %147 = x86.ri.add %24, 192 : (!x86.reg64<rsi>) -> !x86.reg64<rsi>
// CHECK-NEXT:      %148 = x86.ri.sub %23, 128 : (!x86.reg64<rdi>) -> !x86.reg64<rdi>
// CHECK-NEXT:      x86_scf.yield %148, %147, %146, %26, %27 : !x86.reg64<rdi>, !x86.reg64<rsi>, !x86.reg64<rdx>, !x86.reg64<rbp>, !x86.reg64<rsp>
// CHECK-NEXT:    }
// CHECK-NEXT:    %149 = x86.ds.mov %14 : (!x86.reg64<rbp>) -> !x86.reg64<rsp>
// CHECK-NEXT:    %150, %151 = x86.d.pop %149 : (!x86.reg64<rsp>) -> (!x86.reg64<rsp>, !x86.reg64<rbp>)
